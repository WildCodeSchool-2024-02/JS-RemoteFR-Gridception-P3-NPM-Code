      ...
      {selectedSection === "legalsMentions" && (
        <section className="legalsMentionsContent">
          ...
          <p>
            ...
            téléphone : [Numéro de téléphone] Adresse email : [Email de contact]
            Numéro SIRET : [Numéro SIRET] Directeur de la publication : [Nom du
            directeur]
            <br /> <br />
            <strong>2. Hébergeur du Site</strong> <br /> Le Site est hébergé par
            : Nom de l'hébergeur : [Nom de l'hébergeur] Adresse : [Adresse
            complète de l'hébergeur] Numéro de téléphone : [Numéro de téléphone
            de l'hébergeur] Adresse email : [Email de contact de l'hébergeur]{" "}
            <br /> <br />
            <strong>3. Propriété Intellectuelle</strong> <br /> Le contenu du
            Site (textes, images, vidéos, logos, etc.) est protégé par les lois
            en vigueur sur la propriété intellectuelle et appartient à [Votre
            ...
            de NPM Code.
            <br /> <br />
            <strong>4. Données Personnelles</strong> <br /> Conformément à la
            loi Informatique et Libertés du 6 janvier 1978 modifiée, et au
            Règlement Général sur la Protection des Données (RGPD) entré en
            vigueur le 25 mai 2018, les utilisateurs disposent d'un droit
            d'accès, de rectification, de suppression et d'opposition aux
            données personnelles les concernant. Pour exercer ce droit, veuillez
            nous contacter à l'adresse suivante : [Email de contact pour les
            données personnelles] 5. Cookies Le Site utilise des cookies pour
            améliorer l'expérience utilisateur, analyser le trafic et les
            performances du Site. En continuant à naviguer sur le Site, vous
            acceptez l'utilisation de cookies.
            <br /> <br />
            <strong>5. Responsabilité</strong> <br /> NPM Code ne saurait être
            tenue responsable des dommages directs ou indirects causés au
            ...
            NPM Code ne pourra également être tenue responsable des dommages
            indirects (tels par exemple qu'une perte de marché ou perte d'une
            chance) consécutifs à l'utilisation du Site. Des espaces interactifs
            (possibilité de poser des questions dans l’espace contact) sont à la
            disposition des utilisateurs. <br />
            NPM Code se réserve le droit de supprimer, sans mise en demeure
            ...
            photographie …). <br /> <br />
            <strong>6. Liens Hypertextes</strong> <br /> Le Site peut contenir
            des liens hypertextes vers d'autres sites. NPM Code n'exerce aucun
            contrôle sur ces sites et n'assume aucune responsabilité quant à
            leur contenu. En conséquence, NPM Code décline toute responsabilité
            quant aux contenus, publicités, produits, services ou tout autre
            matériel disponible sur ou à partir de ces sites.
            <br /> <br />
            <strong>
            ...
            tribunaux compétents de REMOTE City. <br /> <br />
            <strong>8. Contact</strong> <br /> Pour toute question concernant
            les mentions légales du Site, vous pouvez nous contacter à l'adresse
      ...
      {selectedSection === "cguContent" && (
        <section className="cguContent">
          ...
          <p>
            ...
            œuvres de street art géolocalisées. Les utilisateurs peuvent ajouter
            leurs propres contributions et visualiser celles des autres. <br />{" "}
            <br />
            <strong>2. Acceptation des Conditions Générales </strong>
            <br /> En accédant et en utilisant le Site, vous acceptez sans
            réserve les présentes Conditions Générales d'Utilisation (CGU). Si
            vous n'acceptez pas ces termes, veuillez ne pas utiliser le Site.{" "}
            <br /> <br />
            <strong>3. Accès au Site </strong> <br /> L'accès au Site est ouvert
            à toute personne disposant d'un accès à internet. Les frais liés à
            l'accès au Site (matériel informatique, logiciels, connexion
            internet, etc.) sont à la charge de l'utilisateur. <br /> <br />
            <strong>4. Inscription et Compte Utilisateur</strong> <br />{" "}
            ...
            <strong>5. Utilisation du Site</strong> <br /> Les utilisateurs
            s'engagent à utiliser le Site de manière conforme à la loi et aux
            bonnes mœurs. <br /> <br />
            ...
            <strong>6. Ajout et Partage de Contenus</strong> <br /> Les
            utilisateurs peuvent ajouter des œuvres de street art en fournissant
            une photo, une position GPS, une description et le nom de l'artiste,
            si connu. Les œuvres ajoutées doivent être uniques et ne pas déjà
            figurer sur le Site. Les photos doivent être de bonne qualité et
            représenter fidèlement l'œuvre.
            <br /> <br />
            <strong>7. Système de Points et Classement </strong> <br />
            ...
            <br /> <br />
            <strong>8. Propriété Intellectuelle</strong> <br /> Les utilisateurs
            ...
            <strong>9. Modération des Contenus</strong> <br /> Le Site se
            réserve le droit de modérer, modifier ou supprimer tout contenu ne
            respectant pas les présentes CGU. Les utilisateurs peuvent signaler
            des contenus inappropriés ou incorrectement attribués via les outils
            de signalement du Site.
            <br /> <br />
            ...
            <br />
            <br />
            <strong>10. Protection des Données Personnelles</strong> <br /> Le
            Site s'engage à respecter la vie privée des utilisateurs et à
            ...
            consentement.
            <br /> <br />
            <strong>11. Modification des CGU</strong> <br /> Le Site se réserve
            le droit de modifier les présentes CGU à tout moment. Les
            utilisateurs seront informés des modifications importantes et sont
            invités à consulter régulièrement les CGU mises à jour.
            <br /> <br />
            <strong>
              12. Loi Applicable et Juridiction Compétente
            </strong> <br /> Les présentes CGU sont soumises au droit français.
            ...
            compétents. En utilisant le Site, vous acceptez de respecter ces
            Conditions Générales d'Utilisation. Merci de votre participation et
            de votre respect des règles établies pour le bénéfice de toute la
            communauté.
          </p>
        </section>
      )}
